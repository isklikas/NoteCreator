...
-(void)viewDidAppear:(BOOL)animated {
    NSString *path = [@"/var/mobile/Library/Preferences" stringByAppendingPathComponent:@"isklikas.notesCreator.plist"];
...
- (void)viewDidLoad {
    [super viewDidLoad];
    NSBundle *ourBundle = [[NSBundle alloc] initWithPath:@"/Library/NotesCreator/Translations.bundle/"];
    ...
    NSString *path2 = [@"/var/mobile/Library/Preferences" stringByAppendingPathComponent:@"isklikas.notesCreator.plist"];
    ...
    NSString *path = @"/Library/NotesCreator/noteText.plist";
    NSDictionary *dictionary = [[NSDictionary alloc] initWithContentsOfFile:path];
...
-(void) repeatedCreations {
    ...
    UIImage *bg = [UIImage imageWithContentsOfFile:@"/Library/NotesCreator/bg.png"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIImage *arrow = [UIImage imageWithContentsOfFile:@"/Library/NotesCreator/arrow.png"];
...
- (void) done:(id) sender {
    ...
    NoteObject *noted = [NSClassFromString(@"NSEntityDescription") insertNewObjectForEntityForName:@"Note" inManagedObjectContext:context];
    ...
    if ([note.text isEqual:[@"  " stringByAppendingString:noteStr]] || note.text==nil || [note.text isEqual:@""]) {
        ...
        NSString *filePath = @"/Library/NotesCreator/noteText.plist";
